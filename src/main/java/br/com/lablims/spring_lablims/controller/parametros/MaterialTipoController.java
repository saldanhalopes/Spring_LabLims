...
public class MaterialTipoController {
    ...
    public String list(@RequestParam(required = false) final String filter,
        ...
        return "parameters/materialTipo/list";
    }

    @GetMapping("/add")
    public String add(@ModelAttribute("materialTipo") final MaterialTipoDTO materialTipoDTO) {
        return "parameters/materialTipo/add";
    }

    @PreAuthorize("hasAnyAuthority('" + UserRoles.ADMIN + "', '" + UserRoles.MASTERUSER + "', '" + UserRoles.POWERUSER + "')")
    @PostMapping("/add")
    public String add(@ModelAttribute("materialTipo") @Valid final MaterialTipoDTO materialTipoDTO, final Model model,
    ...
    public String edit(@PathVariable final Integer id, final Model model) {
        ...
        return "parameters/materialTipo/edit";
    }
    ...
    public String getRevisions(Model model) {
        ...
        return "parameters/materialTipo/audit";
    }
